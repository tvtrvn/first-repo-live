...
This project is indexed by GitNexus as **first-repo-live** (158 symbols, 188 relationships, 2 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
